...
class Distance(models.Model):
    ...
    # length = models.PositiveIntegerField(max_digits=4)
    kilometers = 'km'
    miles = 'mi'
...
#     def __str__(self):
#         return {self.distance} {self.event}
...
class Event(models.Model):
    ...
    # distance = models.MayToManyField(Distance, through='EventDistanceM2M')
    # sub_category = models.ManyToManyField(SubCategory, through='SubCatEventM2M')
